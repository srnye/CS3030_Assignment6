...
"""
steven_nye_task1_module1_hw7.py
...
def main():
    ...
    Returns:
        Nothing
    """
    hr = input("Enter Header Record: ")
    ld = input("Enter Left Dashboard switch (0 or 1): ")
    rd = input("Enter Right Dashboard switch (0 or 1): ")
    cl = input("Enter Child Lock switch (0 or 1): ")
    ml = input("Enter Master unLock switch (0 or 1): ")
    li = input("Enter Left Inside handle (0 or 1): ")
    lo = input("Enter Left Oustide handle (0 or 1): ")
    ri = input("Enter Right Inside handle (0 or 1): ")
    ro = input("Enter Right Outside handle (0 or 1): ")
    gs = input("Enter Gear Shift position (P, N, D, 1, 2, 3 or R): ")
    mod1(hr, ld, rd, cl, ml, li, lo, ri, ro, gs)
